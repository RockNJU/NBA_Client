...
public class SingleTeamInfo extends JPanel {
	JButton basicinfo;
	JButton moreinfo;
	JButton analysis;
	JPanel infopanel;
	 ...
	 * Create the panel.
	 */
	public SingleTeamInfo(String Name) {
		this.setLayout(null);
		this.name=Name;
...
try {
		...
		moreinfo.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                // TODO Auto-generated method stub
            	MoreInfo_1 bi=new MoreInfo_1(name);
            	changeInfoPanel(bi);
            }
        });	
		analysis.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                // TODO Auto-generated method stub
            	AnalysisInfo_1 bi=new AnalysisInfo_1(name);
            	changeInfoPanel(bi);
            }
        });	
	}

	public void changeInfoPanel(BasicInfo_1 panel){
		infopanel.removeAll();
		infopanel.add(panel);
	...
	public void changeInfoPanel(MoreInfo_1 panel){
		infopanel.removeAll();
		infopanel.add(panel);
		panel.setVisible(true);
		panel.setBounds(0,0, 582, 474);
	...
	public void changeInfoPanel(AnalysisInfo_1 panel){
		infopanel.removeAll();
		infopanel.add(panel);
		panel.setVisible(true);
		panel.setBounds(0,0,582, 474);
	...
	public static void main(String[] args) {
		JFrame a=new JFrame();
		SingleTeamInfo b=	new SingleTeamInfo("player name");
		a.setVisible(true);
		a.setBounds(200, 10,607, 639);
